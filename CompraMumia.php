...
<body>
    ...
    <div class="esquerda">
        ...
        <div class="imagemprincipal"><img src="imagem/mumia.png" width="90%"></div>
    </div>
    <div class="direita">
        ...
        <?php
            ...
            {
                $comando = $pdo->prepare("INSERT INTO `produtos` (`nome_produto`, `preco_produto`, `qtd_produto`, `carrinho`)VALUE('Mumia Mommy', '97.00', '1', '1')");
